...
_NODE_TO_STAGE: dict[str, UITraceStage] = {
    ...
    "assess_situation": UITraceStage.POLICY_EVALUATION,
    "synthesize_handling": UITraceStage.RESPONSE,
    "check_pending_action": UITraceStage.CONFIRMATION,
    "handle_workflow_interruption": UITraceStage.ROUTING,
    "restore_suspended_workflow": UITraceStage.ROUTING,
...
_NODE_TO_EVENT: dict[str, str] = {
    ...
    "assess_situation": "policy.checked",
    "synthesize_handling": "proposal.validated",
    "check_pending_action": "confirmation.resolved",
    "handle_workflow_interruption": "workflow.suspended",
